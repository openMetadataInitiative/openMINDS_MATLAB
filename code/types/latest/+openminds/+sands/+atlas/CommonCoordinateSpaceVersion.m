...
%
%   isPrecededBy              : (1,1) <a href="matlab:help openminds.sands.atlas.CommonCoordinateSpaceVersion" style="font-weight:bold">CommonCoordinateSpaceVersion</a>
%                               Add the common coordinate space version preceding this common coordinate space version.
%
%   isVariantOf               : (1,:) <a href="matlab:help openminds.sands.atlas.CommonCoordinateSpaceVersion" style="font-weight:bold">CommonCoordinateSpaceVersion</a>
%                               Add all common coordinate space versions that can be used alternatively to this common coordinate space version.
%
%   isVersionOf               : (1,1) <a href="matlab:help openminds.sands.atlas.CommonCoordinateSpace" style="font-weight:bold">CommonCoordinateSpace</a>
%                               Add the version-independent information about this common coordinate space.
%
...
%   This class was auto-generated by the openMINDS pipeline
    ...
    properties
        ...
        % Add the common coordinate space version preceding this common coordinate space version.
        isPrecededBy (1,:) openminds.sands.atlas.CommonCoordinateSpaceVersion ...
            {mustBeSpecifiedLength(isPrecededBy, 0, 1)}

        % Add all common coordinate space versions that can be used alternatively to this common coordinate space version.
        isVariantOf (1,:) openminds.sands.atlas.CommonCoordinateSpaceVersion ...
            {mustBeListOfUniqueItems(isVariantOf)}

        % Add the version-independent information about this common coordinate space.
        isVersionOf (1,:) openminds.sands.atlas.CommonCoordinateSpace ...
    ...
    properties (Access = protected)
        Required = ["accessibility", "anatomicalAxesOrientation", "axesOrigin", "fullDocumentation", "isVersionOf", "nativeUnit", "releaseDate", "shortName", "versionIdentifier", "versionInnovation"]
    end
    ...
    properties (Constant, Hidden)
        LINKED_PROPERTIES = struct(...
            ...
            'isPrecededBy', "openminds.sands.atlas.CommonCoordinateSpaceVersion", ...
            'isVariantOf', "openminds.sands.atlas.CommonCoordinateSpaceVersion", ...
            'isVersionOf', "openminds.sands.atlas.CommonCoordinateSpace", ...
