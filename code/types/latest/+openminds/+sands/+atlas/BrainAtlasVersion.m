...
%
%   coordinateSpace        : (1,1) <a href="matlab:help openminds.sands.atlas.CommonCoordinateSpaceVersion" style="font-weight:bold">CommonCoordinateSpaceVersion</a>
...
%   This class was auto-generated by the openMINDS pipeline
    ...
    properties
        ...
        % Add the brain atlas version preceding this brain atlas version.
        isPrecededBy (1,:) openminds.sands.atlas.BrainAtlasVersion ...
            {mustBeSpecifiedLength(isPrecededBy, 0, 1)}

        % Add all brain atlas versions that can be used alternatively to this brain atlas version.
        isVariantOf (1,:) openminds.sands.atlas.BrainAtlasVersion ...
            {mustBeListOfUniqueItems(isVariantOf)}

        % Add the version-independent information about this brain atlas.
        isVersionOf (1,:) openminds.sands.atlas.BrainAtlas ...
    ...
    properties (Access = protected)
        Required = ["accessibility", "coordinateSpace", "fullDocumentation", "hasTerminology", "isVersionOf", "license", "releaseDate", "shortName", "versionIdentifier", "versionInnovation"]
    end
    ...
    properties (Constant, Hidden)
        LINKED_PROPERTIES = struct(...
            ...
            'isPrecededBy', "openminds.sands.atlas.BrainAtlasVersion", ...
            'isVariantOf', "openminds.sands.atlas.BrainAtlasVersion", ...
            'isVersionOf', "openminds.sands.atlas.BrainAtlas", ...
