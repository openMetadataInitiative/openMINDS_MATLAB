...
%
%   isPrecededBy           : (1,1) <a href="matlab:help openminds.core.products.InterfaceVersion" style="font-weight:bold">InterfaceVersion</a>
%                            Add the interface version preceding this one.
%
%   isVariantOf            : (1,:) <a href="matlab:help openminds.core.products.InterfaceVersion" style="font-weight:bold">InterfaceVersion</a>
%                            Add all interface versions that can be used alternatively to this one.
%
%   isVersionOf            : (1,1) <a href="matlab:help openminds.core.products.Interface" style="font-weight:bold">Interface</a>
%                            Add the version-independent information about this interface.
%
...
%
%   specification          : (1,1) <a href="matlab:help openminds.core.data.File" style="font-weight:bold">File</a>, <a href="matlab:help openminds.core.miscellaneous.WebResource" style="font-weight:bold">WebResource</a>
...
%   This class was auto-generated by the openMINDS pipeline
    ...
    properties
        ...
        % Add the interface version preceding this one.
        isPrecededBy (1,:) openminds.core.products.InterfaceVersion ...
            {mustBeSpecifiedLength(isPrecededBy, 0, 1)}

        % Add all interface versions that can be used alternatively to this one.
        isVariantOf (1,:) openminds.core.products.InterfaceVersion ...
            {mustBeListOfUniqueItems(isVariantOf)}

        % Add the version-independent information about this interface.
        isVersionOf (1,:) openminds.core.products.Interface ...
    ...
    properties (Access = protected)
        Required = ["accessibility", "contribution", "description", "documentation", "fullName", "isVersionOf", "releaseDate", "shortName", "versionIdentifier", "versionSpecification"]
    end

    properties (Constant, Hidden)
        X_TYPE = "https://openminds.om-i.org/types/InterfaceVersion"
    end
    ...
    properties (Constant, Hidden)
        LINKED_PROPERTIES = struct(...
            ...
            'isPrecededBy', "openminds.core.products.InterfaceVersion", ...
            'isVariantOf', "openminds.core.products.InterfaceVersion", ...
            'isVersionOf', "openminds.core.products.Interface", ...
            ...
            'specification', ["openminds.core.data.File", "openminds.core.miscellaneous.WebResource"], ...
    ...
    methods
        function obj = InterfaceVersion(structInstance, propValues)
            arguments
                structInstance (1,:) {mustBeA(structInstance, 'struct')} = struct.empty
                propValues.?openminds.core.products.InterfaceVersion
