...
%
%   hasPart            : (1,:) <a href="matlab:help openminds.core.products.SoftwareVersion" style="font-weight:bold">SoftwareVersion</a>
...
%
%   isPrecededBy       : (1,1) <a href="matlab:help openminds.core.products.WebServiceVersion" style="font-weight:bold">WebServiceVersion</a>
%                        Add the web service version preceding this web service version.
%
%   isVariantOf        : (1,:) <a href="matlab:help openminds.core.products.WebServiceVersion" style="font-weight:bold">WebServiceVersion</a>
%                        Add all web service versions that can be used alternatively to this web service version.
%
%   isVersionOf        : (1,1) <a href="matlab:help openminds.core.products.WebService" style="font-weight:bold">WebService</a>
%                        Add the version-independent information about this web service.
%
...
%   This class was auto-generated by the openMINDS pipeline
    ...
    properties
        ...
        % Add the web service version preceding this web service version.
        isPrecededBy (1,:) openminds.core.products.WebServiceVersion ...
            {mustBeSpecifiedLength(isPrecededBy, 0, 1)}

        % Add all web service versions that can be used alternatively to this web service version.
        isVariantOf (1,:) openminds.core.products.WebServiceVersion ...
            {mustBeListOfUniqueItems(isVariantOf)}

        % Add the version-independent information about this web service.
        isVersionOf (1,:) openminds.core.products.WebService ...
    ...
    properties (Access = protected)
        Required = ["accessibility", "fullDocumentation", "isVersionOf", "releaseDate", "shortName", "versionIdentifier", "versionInnovation"]
    end
    ...
    properties (Constant, Hidden)
        LINKED_PROPERTIES = struct(...
            ...
            'isPrecededBy', "openminds.core.products.WebServiceVersion", ...
            'isVariantOf', "openminds.core.products.WebServiceVersion", ...
            'isVersionOf', "openminds.core.products.WebService", ...
