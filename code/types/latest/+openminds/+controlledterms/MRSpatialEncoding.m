classdef MRSpatialEncoding < openminds.abstract.ControlledTerm
%MRSpatialEncoding - No description available.
%
%   PROPERTIES:
%
...
%   This class was auto-generated by the openMINDS pipeline
    ...
    properties (Constant, Hidden)
        X_TYPE = "https://openminds.om-i.org/types/MRSpatialEncoding"
    end
    ...
    methods (Static)
        function instances = listInstances()
            instances = openminds.controlledterms.MRSpatialEncoding.CONTROLLED_INSTANCES';
        end
    end
end
