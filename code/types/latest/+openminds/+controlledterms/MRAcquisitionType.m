classdef MRAcquisitionType < openminds.abstract.ControlledTerm
%MRAcquisitionType - No description available.
%
%   PROPERTIES:
%
...
%   This class was auto-generated by the openMINDS pipeline
    ...
    properties (Constant, Hidden)
        X_TYPE = "https://openminds.om-i.org/types/MRAcquisitionType"
    end
    ...
    methods
        function obj = MRAcquisitionType(varargin)
    ...
    methods (Static)
        function instances = listInstances()
            instances = openminds.controlledterms.MRAcquisitionType.CONTROLLED_INSTANCES';
        end
    end
end
