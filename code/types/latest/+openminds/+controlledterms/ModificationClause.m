classdef ModificationClause < openminds.abstract.ControlledTerm
%ModificationClause - No description available.
%
%   PROPERTIES:
%
...
%   This class was auto-generated by the openMINDS pipeline
    ...
    properties (Constant, Hidden)
        X_TYPE = "https://openminds.om-i.org/types/ModificationClause"
    end
    ...
    methods
        function obj = ModificationClause(instanceSpec, propValues)
            arguments
                instanceSpec = []
    ...
    methods (Static)
        function instances = listInstances()
            instances = openminds.controlledterms.ModificationClause.CONTROLLED_INSTANCES';
        end
    end
end
