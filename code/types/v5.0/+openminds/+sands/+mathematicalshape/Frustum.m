classdef Frustum < openminds.abstract.Schema
%Frustum - No description available.
%
%   PROPERTIES:
%
...
%   This class was auto-generated by the openMINDS pipeline
    ...
    properties (Access = protected)
        Required = ["baseDistance", "majorBaseShape", "minorBaseScale"]
    end

    properties (Constant, Hidden)
        X_TYPE = "https://openminds.om-i.org/types/Frustum"
    end
    ...
    properties (Constant, Hidden)
        ...
        EMBEDDED_PROPERTIES = struct(...
            ...
            'majorBaseShape', ["openminds.sands.mathematicalshape.Circle", "openminds.sands.mathematicalshape.CircularSector", "openminds.sands.mathematicalshape.Ellipse", "openminds.sands.mathematicalshape.EquilateralTriangle", "openminds.sands.mathematicalshape.IsoscelesTriangle", "openminds.sands.mathematicalshape.Kite", "openminds.sands.mathematicalshape.Parallelogram", "openminds.sands.mathematicalshape.Rectangle", "openminds.sands.mathematicalshape.RegularPolygon", "openminds.sands.mathematicalshape.Rhombus", "openminds.sands.mathematicalshape.RightTriangle", "openminds.sands.mathematicalshape.Square", "openminds.sands.mathematicalshape.Trapezoid", "openminds.sands.mathematicalshape.Triangle"] ...
        )
    end

    methods
        function obj = Frustum(structInstance, propValues)
            arguments
                structInstance (1,:) {mustBeA(structInstance, 'struct')} = struct.empty
                propValues.?openminds.sands.mathematicalshape.Frustum
