...
%
%   isPrecededBy           : (1,1) <a href="matlab:help openminds.core.products.ModelVersion" style="font-weight:bold">ModelVersion</a>
%                            Add the model version preceding this model version.
%
%   isVariantOf            : (1,:) <a href="matlab:help openminds.core.products.ModelVersion" style="font-weight:bold">ModelVersion</a>
%                            Add all model versions that can be used alternatively to this model version.
%
%   isVersionOf            : (1,1) <a href="matlab:help openminds.core.products.Model" style="font-weight:bold">Model</a>
%                            Add the version-independent information about this model.
%
...
%   This class was auto-generated by the openMINDS pipeline
    ...
    properties
        ...
        format (1,:) openminds.core.data.ContentType ...
            {mustBeMinLength(format, 1), mustBeListOfUniqueItems(format)}
        ...
        % Add all model versions that can be used alternatively to this model version.
        isVariantOf (1,:) openminds.core.products.ModelVersion ...
            {mustBeMinLength(isVariantOf, 1), mustBeListOfUniqueItems(isVariantOf)}

        % Add the version-independent information about this model.
        isVersionOf (1,:) openminds.core.products.Model ...
    ...
    properties (Access = protected)
        Required = ["accessibility", "contribution", "description", "documentation", "format", "fullName", "isVersionOf", "releaseDate", "shortName", "versionIdentifier", "versionSpecification"]
    end
    ...
    properties (Constant, Hidden)
        LINKED_PROPERTIES = struct(...
            ...
            'isPrecededBy', "openminds.core.products.ModelVersion", ...
            'isVariantOf', "openminds.core.products.ModelVersion", ...
            'isVersionOf', "openminds.core.products.Model", ...
