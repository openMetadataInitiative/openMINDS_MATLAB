...
%
%   ethicsJurisdiction     : (1,1) <a href="matlab:help openminds.controlledterms.SovereignState" style="font-weight:bold">SovereignState</a>, <a href="matlab:help openminds.controlledterms.SupranationalBody" style="font-weight:bold">SupranationalBody</a>
...
%
%   isPrecededBy           : (1,1) <a href="matlab:help openminds.core.products.DatasetVersion" style="font-weight:bold">DatasetVersion</a>
%                            Add the dataset version preceding this dataset version.
%
%   isVariantOf            : (1,:) <a href="matlab:help openminds.core.products.DatasetVersion" style="font-weight:bold">DatasetVersion</a>
%                            Add all dataset versions that can be used alternatively to this dataset version.
%
%   isVersionOf            : (1,1) <a href="matlab:help openminds.core.products.Dataset" style="font-weight:bold">Dataset</a>
%                            Add the version-independent information about this dataset.
%
...
%
%   preparationType        : (1,:) <a href="matlab:help openminds.controlledterms.PreparationType" style="font-weight:bold">PreparationType</a>
%                            Add all preparation types used in this dataset version.
%
%   protocol               : (1,:) <a href="matlab:help openminds.core.research.BehavioralProtocol" style="font-weight:bold">BehavioralProtocol</a>, <a href="matlab:help openminds.core.research.Protocol" style="font-weight:bold">Protocol</a>
%                            Add all protocols that were performed in this dataset version.
%
%   publicationStatus      : (1,1) <a href="matlab:help openminds.controlledterms.PublicationStatus" style="font-weight:bold">PublicationStatus</a>
...
%
%   usageCondition         : (1,:) <a href="matlab:help openminds.core.data.License" style="font-weight:bold">License</a>, <a href="matlab:help openminds.core.data.UsageAgreement" style="font-weight:bold">UsageAgreement</a>
...
%
%   versionSpecification   : (1,1) string
...
%   This class was auto-generated by the openMINDS pipeline
    ...
    properties
        ...
        ethicsJurisdiction (1,:) openminds.internal.mixedtype.datasetversion.EthicsJurisdiction ...
            {mustBeSpecifiedLength(ethicsJurisdiction, 0, 1)}
        ...
        % Add all dataset versions that can be used alternatively to this dataset version.
        isVariantOf (1,:) openminds.core.products.DatasetVersion ...
            {mustBeListOfUniqueItems(isVariantOf)}

        % Add the version-independent information about this dataset.
        isVersionOf (1,:) openminds.core.products.Dataset ...
        ...
        preparationType (1,:) openminds.controlledterms.PreparationType ...
            {mustBeListOfUniqueItems(preparationType)}
    ...
    properties (Access = protected)
        Required = ["accessibility", "contribution", "dataType", "description", "digitalIdentifier", "documentation", "ethicsJurisdiction", "experimentalApproach", "fullName", "isVersionOf", "releaseDate", "shortName", "technique", "versionIdentifier", "versionSpecification"]
    end
    ...
    properties (Constant, Hidden)
        LINKED_PROPERTIES = struct(...
            ...
            'digitalIdentifier', ["openminds.core.digitalidentifier.DOI", "openminds.core.digitalidentifier.GenericIdentifier", "openminds.core.digitalidentifier.IdentifiersDotOrgID", "openminds.core.digitalidentifier.RRID"], ...
            ...
            'ethicsJurisdiction', ["openminds.controlledterms.SovereignState", "openminds.controlledterms.SupranationalBody"], ...
            'experimentalApproach', "openminds.controlledterms.ExperimentalApproach", ...
            'funding', "openminds.core.miscellaneous.Funding", ...
            'inputData', ["openminds.core.data.File", "openminds.core.data.FileBundle", "openminds.core.digitalidentifier.DOI", "openminds.core.miscellaneous.WebResource", "openminds.sands.atlas.AnatomicalAtlas", "openminds.sands.atlas.AnatomicalAtlasVersion", "openminds.sands.atlas.CommonCoordinateFramework", "openminds.sands.atlas.CommonCoordinateFrameworkVersion"], ...
            'isPrecededBy', "openminds.core.products.DatasetVersion", ...
            'isVariantOf', "openminds.core.products.DatasetVersion", ...
            'isVersionOf', "openminds.core.products.Dataset", ...
            ...
            'protocol', ["openminds.core.research.BehavioralProtocol", "openminds.core.research.Protocol"], ...
            ...
            'studiedSpecimen', ["openminds.core.research.Subject", "openminds.core.research.SubjectGroup", "openminds.core.research.SubjectGroupState", "openminds.core.research.SubjectState", "openminds.core.research.TissueSample", "openminds.core.research.TissueSampleCollection", "openminds.core.research.TissueSampleCollectionState", "openminds.core.research.TissueSampleState"], ...
            ...
            'usageCondition', ["openminds.core.data.License", "openminds.core.data.UsageAgreement"] ...
        )
