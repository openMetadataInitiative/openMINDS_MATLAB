...
%
%   isPrecededBy           : (1,1) <a href="matlab:help openminds.computation.ValidationTestVersion" style="font-weight:bold">ValidationTestVersion</a>
%                            Add the validation test version preceding this validation test version.
%
%   isVariantOf            : (1,:) <a href="matlab:help openminds.computation.ValidationTestVersion" style="font-weight:bold">ValidationTestVersion</a>
%                            Add all validation test versions that can be used alternatively to this validation test version.
%
%   isVersionOf            : (1,1) <a href="matlab:help openminds.computation.ValidationTest" style="font-weight:bold">ValidationTest</a>
%                            Add the version-independent information about this validation test.
%
...
%   This class was auto-generated by the openMINDS pipeline
    ...
    properties
        ...
        % Add the validation test version preceding this validation test version.
        isPrecededBy (1,:) openminds.computation.ValidationTestVersion ...
            {mustBeSpecifiedLength(isPrecededBy, 0, 1)}

        % Add all validation test versions that can be used alternatively to this validation test version.
        isVariantOf (1,:) openminds.computation.ValidationTestVersion ...
            {mustBeListOfUniqueItems(isVariantOf)}

        % Add the version-independent information about this validation test.
        isVersionOf (1,:) openminds.computation.ValidationTest ...
    ...
    properties (Constant, Hidden)
        LINKED_PROPERTIES = struct(...
            ...
            'isPrecededBy', "openminds.computation.ValidationTestVersion", ...
            'isVariantOf', "openminds.computation.ValidationTestVersion", ...
            'isVersionOf', "openminds.computation.ValidationTest", ...
