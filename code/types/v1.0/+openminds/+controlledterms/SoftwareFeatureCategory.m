classdef SoftwareFeatureCategory < openminds.abstract.ControlledTerm
...
%   This class was auto-generated by the openMINDS pipeline
    ...
    properties (Constant, Hidden)
        X_TYPE = "https://openminds.ebrains.eu/controlledTerms/SoftwareFeatureCategory"
    end
    ...
    methods
        function obj = SoftwareFeatureCategory(varargin)
    ...
    methods (Static)
        function instances = listInstances()
            instances = openminds.controlledterms.SoftwareFeatureCategory.CONTROLLED_INSTANCES';
        end
    end
end
