classdef ProductAccessibility < openminds.controlledterms.ControlledTerm
...
%   This class was auto-generated by the openMINDS pipeline
    ...
    methods
        function obj = ProductAccessibility(instanceSpec, propValues)
            arguments
                instanceSpec = []
                propValues.?openminds.controlledterms.ProductAccessibility
    ...
    methods (Static)
        function instances = listInstances()
            instances = openminds.controlledterms.ProductAccessibility.CONTROLLED_INSTANCES';
        end
    end
end
