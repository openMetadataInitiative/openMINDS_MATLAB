classdef WebServiceVersion < openminds.Node
...
%
%   isAlternativeVersionOf : (1,:) <a href="matlab:help openminds.core.products.WebServiceVersion" style="font-weight:bold">WebServiceVersion</a>
%                            Add all web service versions that can be used alternatively to this web service version.
%
%   isNewVersionOf         : (1,1) <a href="matlab:help openminds.core.products.WebServiceVersion" style="font-weight:bold">WebServiceVersion</a>
...
%   This class was auto-generated by the openMINDS pipeline
    ...
    properties (SetObservable)
        ...
        custodian (1,:) openminds.internal.mixedtype.webserviceversion.Custodian ...
            {mustBeMinLength(custodian, 1), mustBeListOfUniqueItems(custodian)} = openminds.internal.mixedtype.webserviceversion.Custodian()
        ...
        developer (1,:) openminds.internal.mixedtype.webserviceversion.Developer ...
            {mustBeMinLength(developer, 1), mustBeListOfUniqueItems(developer)} = openminds.internal.mixedtype.webserviceversion.Developer()

        % Add the publication or file that acts as the full documentation of this research product version.
        fullDocumentation (1,:) openminds.internal.mixedtype.webserviceversion.FullDocumentation ...
            {mustBeScalarOrEmpty(fullDocumentation)} = openminds.internal.mixedtype.webserviceversion.FullDocumentation()
        ...
        keyword (1,:) openminds.internal.mixedtype.webserviceversion.Keyword ...
            {mustBeMinLength(keyword, 1), mustBeListOfUniqueItems(keyword)} = openminds.internal.mixedtype.webserviceversion.Keyword()
        ...
        relatedPublication (1,:) openminds.internal.mixedtype.webserviceversion.RelatedPublication ...
            {mustBeMinLength(relatedPublication, 1), mustBeListOfUniqueItems(relatedPublication)} = openminds.internal.mixedtype.webserviceversion.RelatedPublication()
