classdef LivePaperVersion < openminds.Node
...
%
%   isPrecededBy           : (1,1) <a href="matlab:help openminds.publications.LivePaperVersion" style="font-weight:bold">LivePaperVersion</a>
%                            Add the live paper version preceding this live paper version.
%
%   isVariantOf            : (1,:) <a href="matlab:help openminds.publications.LivePaperVersion" style="font-weight:bold">LivePaperVersion</a>
%                            Add all live paper versions that can be used alternatively to this live paper version.
%
%   isVersionOf            : (1,1) <a href="matlab:help openminds.publications.LivePaper" style="font-weight:bold">LivePaper</a>
%                            Add the version-independent information about this live paper.
%
...
%   This class was auto-generated by the openMINDS pipeline
    ...
    properties (SetObservable)
        ...
        about (1,:) openminds.internal.mixedtype.livepaperversion.About ...
            {mustBeMinLength(about, 1), mustBeListOfUniqueItems(about)} = openminds.internal.mixedtype.livepaperversion.About()
        ...
        % Add the publication or file that acts as the documentation of this research product version. This value overrides the inherited value from the version-independent product.
        documentation (1,:) openminds.internal.mixedtype.livepaperversion.Documentation ...
            {mustBeScalarOrEmpty(documentation)} = openminds.internal.mixedtype.livepaperversion.Documentation()
        ...
        % Add the live paper version preceding this live paper version.
        isPrecededBy (1,:) openminds.publications.LivePaperVersion ...
            {mustBeScalarOrEmpty(isPrecededBy)}

        % Add all live paper versions that can be used alternatively to this live paper version.
        isVariantOf (1,:) openminds.publications.LivePaperVersion ...
            {mustBeMinLength(isVariantOf, 1), mustBeListOfUniqueItems(isVariantOf)}

        % Add the version-independent information about this live paper.
        isVersionOf (1,:) openminds.publications.LivePaper ...
            {mustBeScalarOrEmpty(isVersionOf)}

        % Add all relevant keywords to this research product version either by adding controlled terms or by suggesting new terms. This value overrides the inherited value from the version-independent product.
        keyword (1,:) openminds.internal.mixedtype.livepaperversion.Keyword ...
            {mustBeMinLength(keyword, 1), mustBeListOfUniqueItems(keyword)} = openminds.internal.mixedtype.livepaperversion.Keyword()

        % Enter the date and time on which this live paper version was last modified, formatted as 'YYYY-MM-DDThh:mm:ssTZD' (e.g., '2023-02-07T16:00:00+00:00').
        modificationDate (1,:) datetime ...
            {mustBeScalarOrEmpty(modificationDate)}
        ...
        relatedPublication (1,:) openminds.internal.mixedtype.livepaperversion.RelatedPublication ...
            {mustBeMinLength(relatedPublication, 1), mustBeListOfUniqueItems(relatedPublication)} = openminds.internal.mixedtype.livepaperversion.RelatedPublication()
        ...
        % Add all licenses and available data usage agreements applicable to this product version.
        usageCondition (1,:) openminds.internal.mixedtype.livepaperversion.UsageCondition ...
            {mustBeMinLength(usageCondition, 1), mustBeListOfUniqueItems(usageCondition)} = openminds.internal.mixedtype.livepaperversion.UsageCondition()
    ...
    properties (Access = protected)
        Required = ["accessibility", "contribution", "description", "digitalIdentifier", "documentation", "fullName", "isVersionOf", "releaseDate", "shortName", "usageCondition", "versionIdentifier", "versionSpecification"]
    end
    ...
    properties (Constant, Hidden)
        LINKED_PROPERTIES = struct(...
            ...
            'isPrecededBy', "openminds.publications.LivePaperVersion", ...
            'isVariantOf', "openminds.publications.LivePaperVersion", ...
            'isVersionOf', "openminds.publications.LivePaper", ...
