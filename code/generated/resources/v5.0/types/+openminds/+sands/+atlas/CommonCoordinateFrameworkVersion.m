classdef CommonCoordinateFrameworkVersion < openminds.Node & openminds.internal.mixin.HasControlledInstance
%CommonCoordinateFrameworkVersion - No description available.
%
%   PROPERTIES:
%
%   abbreviation              : (1,1) string
%                               Enter the official abbreviation of this common coordinate framework version.
%
...
%
%   isPrecededBy              : (1,1) <a href="matlab:help openminds.sands.atlas.CommonCoordinateFrameworkVersion" style="font-weight:bold">CommonCoordinateFrameworkVersion</a>
%                               Add the common coordinate framework version preceding this common coordinate framework version.
%
%   isVariantOf               : (1,:) <a href="matlab:help openminds.sands.atlas.CommonCoordinateFrameworkVersion" style="font-weight:bold">CommonCoordinateFrameworkVersion</a>
%                               Add all common coordinate framework versions that can be used alternatively to this common coordinate framework version.
%
%   isVersionOf               : (1,1) <a href="matlab:help openminds.sands.atlas.CommonCoordinateFramework" style="font-weight:bold">CommonCoordinateFramework</a>
...
%   This class was auto-generated by the openMINDS pipeline
    ...
    properties (Access = protected)
        Required = ["accessibility", "anatomicalAxesOrientation", "axesOrigin", "contribution", "description", "documentation", "fullName", "howToCite", "isVersionOf", "nativeUnit", "releaseDate", "shortName", "versionIdentifier", "versionSpecification"]
    end

    properties (Constant, Hidden)
        X_TYPE = "https://openminds.om-i.org/types/CommonCoordinateFrameworkVersion"
    end
    ...
    properties (Constant, Hidden)
        LINKED_PROPERTIES = struct(...
            ...
            'isPrecededBy', "openminds.sands.atlas.CommonCoordinateFrameworkVersion", ...
            'isVariantOf', "openminds.sands.atlas.CommonCoordinateFrameworkVersion", ...
            'isVersionOf', "openminds.sands.atlas.CommonCoordinateFramework", ...
    ...
    methods
        function obj = CommonCoordinateFrameworkVersion(structInstance, propValues)
            arguments
                structInstance (1,:) {mustBeA(structInstance, 'struct')} = struct.empty
                propValues.?openminds.sands.atlas.CommonCoordinateFrameworkVersion
