classdef ModelValidation < openminds.Node
...
%
%   environment         : (1,1) <a href="matlab:help openminds.computation.Environment" style="font-weight:bold">Environment</a>, <a href="matlab:help openminds.core.products.Service" style="font-weight:bold">Service</a>
...
%
%   output              : (1,:) <a href="matlab:help openminds.core.data.File" style="font-weight:bold">File</a>, <a href="matlab:help openminds.core.data.FileBundle" style="font-weight:bold">FileBundle</a>, <a href="matlab:help openminds.core.data.LocalFile" style="font-weight:bold">LocalFile</a>
...
%   This class was auto-generated by the openMINDS pipeline
    ...
    properties (SetObservable)
        ...
        environment (1,:) openminds.internal.mixedtype.modelvalidation.Environment ...
            {mustBeScalarOrEmpty(environment)} = openminds.internal.mixedtype.modelvalidation.Environment()

        % Add all inputs used by this activity.
        input (1,:) openminds.internal.mixedtype.modelvalidation.Input ...
            {mustBeMinLength(input, 1), mustBeListOfUniqueItems(input)} = openminds.internal.mixedtype.modelvalidation.Input()
        ...
        output (1,:) openminds.internal.mixedtype.modelvalidation.Output ...
            {mustBeMinLength(output, 1), mustBeListOfUniqueItems(output)} = openminds.internal.mixedtype.modelvalidation.Output()

        % Add all agents that performed this activity.
        performedBy (1,:) openminds.internal.mixedtype.modelvalidation.PerformedBy ...
            {mustBeMinLength(performedBy, 1), mustBeListOfUniqueItems(performedBy)} = openminds.internal.mixedtype.modelvalidation.PerformedBy()
        ...
        resourceUsage (1,:) openminds.internal.mixedtype.modelvalidation.ResourceUsage ...
            {mustBeMinLength(resourceUsage, 1), mustBeListOfUniqueItems(resourceUsage)} = openminds.internal.mixedtype.modelvalidation.ResourceUsage()
        ...
        startedBy (1,:) openminds.internal.mixedtype.modelvalidation.StartedBy ...
            {mustBeScalarOrEmpty(startedBy)} = openminds.internal.mixedtype.modelvalidation.StartedBy()
        ...
        studyTarget (1,:) openminds.internal.mixedtype.modelvalidation.StudyTarget ...
            {mustBeMinLength(studyTarget, 1), mustBeListOfUniqueItems(studyTarget)} = openminds.internal.mixedtype.modelvalidation.StudyTarget()
        ...
        wasInformedBy (1,:) openminds.internal.mixedtype.modelvalidation.WasInformedBy ...
            {mustBeScalarOrEmpty(wasInformedBy)} = openminds.internal.mixedtype.modelvalidation.WasInformedBy()
    end
    ...
    properties (Constant, Hidden)
        LINKED_PROPERTIES = struct(...
            'environment', ["openminds.computation.Environment", "openminds.core.products.Service"], ...
            'input', ["openminds.computation.ValidationTestVersion", "openminds.core.data.File", "openminds.core.data.FileBundle", "openminds.core.data.LocalFile", "openminds.core.products.ModelVersion", "openminds.core.products.SoftwareVersion"], ...
            'launchConfiguration', "openminds.computation.LaunchConfiguration", ...
            'output', ["openminds.core.data.File", "openminds.core.data.FileBundle", "openminds.core.data.LocalFile"], ...
