...
%   This class was auto-generated by the openMINDS pipeline
    ...
    methods % Hand out the instances a mixed type set holds, not the set
        ...
        function value = get.resourceUsage(obj)
            value = obj.resourceUsage.unwrap();
        end
        ...
        function value = get.wasInformedBy(obj)
            value = obj.wasInformedBy.unwrap();
        end
    end
end
