...
%   This class was auto-generated by the openMINDS pipeline
    ...
    properties (SetObservable)
        ...
        environment (1,:) openminds.internal.mixedtype.datacopy.Environment ...
            {mustBeScalarOrEmpty(environment)} = openminds.internal.mixedtype.datacopy.Environment()

        % Add all inputs used by this activity.
        input (1,:) openminds.internal.mixedtype.datacopy.Input ...
            {mustBeMinLength(input, 1), mustBeListOfUniqueItems(input)} = openminds.internal.mixedtype.datacopy.Input()
        ...
        output (1,:) openminds.internal.mixedtype.datacopy.Output ...
            {mustBeMinLength(output, 1), mustBeListOfUniqueItems(output)} = openminds.internal.mixedtype.datacopy.Output()

        % Add all agents that performed this activity.
        performedBy (1,:) openminds.internal.mixedtype.datacopy.PerformedBy ...
            {mustBeMinLength(performedBy, 1), mustBeListOfUniqueItems(performedBy)} = openminds.internal.mixedtype.datacopy.PerformedBy()
        ...
        resourceUsage (1,:) openminds.internal.mixedtype.datacopy.ResourceUsage ...
            {mustBeMinLength(resourceUsage, 1), mustBeListOfUniqueItems(resourceUsage)} = openminds.internal.mixedtype.datacopy.ResourceUsage()
        ...
        startedBy (1,:) openminds.internal.mixedtype.datacopy.StartedBy ...
            {mustBeScalarOrEmpty(startedBy)} = openminds.internal.mixedtype.datacopy.StartedBy()
        ...
        studyTarget (1,:) openminds.internal.mixedtype.datacopy.StudyTarget ...
            {mustBeMinLength(studyTarget, 1), mustBeListOfUniqueItems(studyTarget)} = openminds.internal.mixedtype.datacopy.StudyTarget()
        ...
        wasInformedBy (1,:) openminds.internal.mixedtype.datacopy.WasInformedBy ...
            {mustBeScalarOrEmpty(wasInformedBy)} = openminds.internal.mixedtype.datacopy.WasInformedBy()
    end
    ...
    properties (Constant, Hidden)
        LINKED_PROPERTIES = struct(...
            ...
            'input', ["openminds.computation.ValidationTestVersion", "openminds.core.data.File", "openminds.core.data.FileBundle", "openminds.core.data.LocalFile", "openminds.core.products.DatasetVersion", "openminds.core.products.ModelVersion", "openminds.core.products.SoftwareVersion"], ...
