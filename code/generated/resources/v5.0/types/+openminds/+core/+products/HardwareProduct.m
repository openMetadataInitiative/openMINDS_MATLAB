...
%
%   specification     : (1,1) <a href="matlab:help openminds.core.research.PropertyValueList" style="font-weight:bold">PropertyValueList</a>
%                       Add the specification(s) of this hardware product as property value list.
%
%   type              : (1,1) <a href="matlab:help openminds.controlledterms.DeviceType" style="font-weight:bold">DeviceType</a>
...
%   This class was auto-generated by the openMINDS pipeline
    ...
    properties (Access = protected)
        Required = ["contribution", "name", "scope", "type"]
    end

    properties (Constant, Hidden)
        X_TYPE = "https://openminds.om-i.org/types/HardwareProduct"
    end

    properties (Constant, Hidden)
        LINKED_PROPERTIES = struct(...
            'contribution', ["openminds.core.actors.Organization", "openminds.core.actors.Person"], ...
            'digitalIdentifier', ["openminds.core.digitalidentifier.DOI", "openminds.core.digitalidentifier.GenericIdentifier", "openminds.core.digitalidentifier.RRID"], ...
            ...
            'specification', "openminds.core.research.PropertyValueList", ...
            'type', "openminds.controlledterms.DeviceType", ...
    ...
    methods
        function obj = HardwareProduct(structInstance, propValues)
            arguments
                structInstance (1,:) {mustBeA(structInstance, 'struct')} = struct.empty
                propValues.?openminds.core.products.HardwareProduct
