...
%
%   dependency             : (1,:) <a href="matlab:help openminds.core.miscellaneous.Dependency" style="font-weight:bold">Dependency</a>
...
%
%   implements             : (1,:) <a href="matlab:help openminds.core.products.InterfaceVersion" style="font-weight:bold">InterfaceVersion</a>
%                            Add all interface versions that are implemented by this software version.
%
...
%
%   isPrecededBy           : (1,1) <a href="matlab:help openminds.core.products.SoftwareVersion" style="font-weight:bold">SoftwareVersion</a>
%                            Add the software version preceding this software version.
%
%   isVariantOf            : (1,:) <a href="matlab:help openminds.core.products.SoftwareVersion" style="font-weight:bold">SoftwareVersion</a>
%                            Add all software versions that can be used alternatively to this software version.
%
%   isVersionOf            : (1,1) <a href="matlab:help openminds.core.products.Software" style="font-weight:bold">Software</a>
%                            Add the version-independent information about this software.
%
...
%
%   operatingDevice        : (1,:) <a href="matlab:help openminds.controlledterms.OperatingDevice" style="font-weight:bold">OperatingDevice</a>
%                            Add all operating devices compatible with this software version.
%
...
%
%   scope                  : (1,:) <a href="matlab:help openminds.controlledterms.AnalysisTechnique" style="font-weight:bold">AnalysisTechnique</a>, <a href="matlab:help openminds.controlledterms.ContributionType" style="font-weight:bold">ContributionType</a>, <a href="matlab:help openminds.controlledterms.DataType" style="font-weight:bold">DataType</a>, <a href="matlab:help openminds.controlledterms.ExperimentalApproach" style="font-weight:bold">ExperimentalApproach</a>, <a href="matlab:help openminds.controlledterms.OperationalApproach" style="font-weight:bold">OperationalApproach</a>, <a href="matlab:help openminds.controlledterms.SoftwareApplicationCategory" style="font-weight:bold">SoftwareApplicationCategory</a>, <a href="matlab:help openminds.controlledterms.SoftwareFeature" style="font-weight:bold">SoftwareFeature</a>, <a href="matlab:help openminds.controlledterms.Technique" style="font-weight:bold">Technique</a>, <a href="matlab:help openminds.controlledterms.TermSuggestion" style="font-weight:bold">TermSuggestion</a>
%                            Add terms that describe what this software version does.
%
...
%   This class was auto-generated by the openMINDS pipeline
    ...
    properties (SetObservable)
        ...
        % Add all operating devices compatible with this software version.
        dependency (1,:) openminds.core.miscellaneous.Dependency ...
            {mustBeMinLength(dependency, 1), mustBeListOfUniqueItems(dependency)}
        ...
        % Add the publication or file that acts as the documentation of this research product version. This value overrides the inherited value from the version-independent product.
        documentation (1,:) openminds.internal.mixedtype.softwareversion.Documentation ...
            {mustBeScalarOrEmpty(documentation)} = openminds.internal.mixedtype.softwareversion.Documentation()
        ...
        % Add all interface versions that are implemented by this software version.
        implements (1,:) openminds.core.products.InterfaceVersion ...
            {mustBeMinLength(implements, 1), mustBeListOfUniqueItems(implements)}
        ...
        % Add the software version preceding this software version.
        isPrecededBy (1,:) openminds.core.products.SoftwareVersion ...
            {mustBeScalarOrEmpty(isPrecededBy)}

        % Add all software versions that can be used alternatively to this software version.
        isVariantOf (1,:) openminds.core.products.SoftwareVersion ...
            {mustBeMinLength(isVariantOf, 1), mustBeListOfUniqueItems(isVariantOf)}

        % Add the version-independent information about this software.
        isVersionOf (1,:) openminds.core.products.Software ...
            {mustBeScalarOrEmpty(isVersionOf)}

        % Add all relevant keywords to this research product version either by adding controlled terms or by suggesting new terms. This value overrides the inherited value from the version-independent product.
        keyword (1,:) openminds.internal.mixedtype.softwareversion.Keyword ...
            {mustBeMinLength(keyword, 1), mustBeListOfUniqueItems(keyword)} = openminds.internal.mixedtype.softwareversion.Keyword()
        ...
        % Add all operating devices compatible with this software version.
        operatingDevice (1,:) openminds.controlledterms.OperatingDevice ...
            {mustBeMinLength(operatingDevice, 1), mustBeListOfUniqueItems(operatingDevice)}
        ...
        % Add terms that describe what this software version does.
        scope (1,:) openminds.internal.mixedtype.softwareversion.Scope ...
            {mustBeMinLength(scope, 1), mustBeListOfUniqueItems(scope)} = openminds.internal.mixedtype.softwareversion.Scope()
        ...
        % Add all licenses and available data usage agreements applicable to this product version.
        usageCondition (1,:) openminds.internal.mixedtype.softwareversion.UsageCondition ...
            {mustBeMinLength(usageCondition, 1), mustBeListOfUniqueItems(usageCondition)} = openminds.internal.mixedtype.softwareversion.UsageCondition()
    ...
    properties (Access = protected)
        Required = ["accessibility", "contribution", "description", "documentation", "fullName", "isVersionOf", "releaseDate", "scope", "shortName", "versionIdentifier", "versionSpecification"]
    end
    ...
    properties (Constant, Hidden)
        LINKED_PROPERTIES = struct(...
            ...
            'digitalIdentifier', ["openminds.core.digitalidentifier.DOI", "openminds.core.digitalidentifier.GenericIdentifier", "openminds.core.digitalidentifier.RRID", "openminds.core.digitalidentifier.SWHID"], ...
            ...
            'implements', "openminds.core.products.InterfaceVersion", ...
            'inputFormat', "openminds.core.data.ContentType", ...
            'isPrecededBy', "openminds.core.products.SoftwareVersion", ...
            'isVariantOf', "openminds.core.products.SoftwareVersion", ...
            'isVersionOf', "openminds.core.products.Software", ...
