...
%
%   isAlternativeVersionOf    : (1,:) <a href="matlab:help openminds.sands.atlas.CommonCoordinateSpaceVersion" style="font-weight:bold">CommonCoordinateSpaceVersion</a>
%                               Add all common coordinate space versions that can be used alternatively to this common coordinate space version.
%
%   isNewVersionOf            : (1,1) <a href="matlab:help openminds.sands.atlas.CommonCoordinateSpaceVersion" style="font-weight:bold">CommonCoordinateSpaceVersion</a>
...
%   This class was auto-generated by the openMINDS pipeline
    ...
    properties (SetObservable)
        ...
        author (1,:) openminds.internal.mixedtype.commoncoordinatespaceversion.Author ...
            {mustBeMinLength(author, 1), mustBeListOfUniqueItems(author)} = openminds.internal.mixedtype.commoncoordinatespaceversion.Author()
        ...
        custodian (1,:) openminds.internal.mixedtype.commoncoordinatespaceversion.Custodian ...
            {mustBeMinLength(custodian, 1), mustBeListOfUniqueItems(custodian)} = openminds.internal.mixedtype.commoncoordinatespaceversion.Custodian()
        ...
        digitalIdentifier (1,:) openminds.internal.mixedtype.commoncoordinatespaceversion.DigitalIdentifier ...
            {mustBeScalarOrEmpty(digitalIdentifier)} = openminds.internal.mixedtype.commoncoordinatespaceversion.DigitalIdentifier()

        % Add the publication or file that acts as the full documentation of this research product version.
        fullDocumentation (1,:) openminds.internal.mixedtype.commoncoordinatespaceversion.FullDocumentation ...
            {mustBeScalarOrEmpty(fullDocumentation)} = openminds.internal.mixedtype.commoncoordinatespaceversion.FullDocumentation()
        ...
        keyword (1,:) openminds.internal.mixedtype.commoncoordinatespaceversion.Keyword ...
            {mustBeMinLength(keyword, 1), mustBeListOfUniqueItems(keyword)} = openminds.internal.mixedtype.commoncoordinatespaceversion.Keyword()
        ...
        relatedPublication (1,:) openminds.internal.mixedtype.commoncoordinatespaceversion.RelatedPublication ...
            {mustBeMinLength(relatedPublication, 1), mustBeListOfUniqueItems(relatedPublication)} = openminds.internal.mixedtype.commoncoordinatespaceversion.RelatedPublication()
        ...
        usedSpecimen (1,:) openminds.internal.mixedtype.commoncoordinatespaceversion.UsedSpecimen ...
            {mustBeMinLength(usedSpecimen, 1), mustBeListOfUniqueItems(usedSpecimen)} = openminds.internal.mixedtype.commoncoordinatespaceversion.UsedSpecimen()
