classdef RecordingActivity < openminds.Node
...
%
%   output             : (1,:) <a href="matlab:help openminds.core.data.File" style="font-weight:bold">File</a>, <a href="matlab:help openminds.core.data.FileBundle" style="font-weight:bold">FileBundle</a>
...
%   This class was auto-generated by the openMINDS pipeline
    ...
    properties (SetObservable)
        ...
        device (1,:) openminds.internal.mixedtype.recordingactivity.Device ...
            {mustBeMinLength(device, 1), mustBeListOfUniqueItems(device)} = openminds.internal.mixedtype.recordingactivity.Device()
        ...
        input (1,:) openminds.internal.mixedtype.recordingactivity.Input ...
            {mustBeMinLength(input, 1), mustBeListOfUniqueItems(input)} = openminds.internal.mixedtype.recordingactivity.Input()
        ...
        output (1,:) openminds.internal.mixedtype.recordingactivity.Output ...
            {mustBeMinLength(output, 1), mustBeListOfUniqueItems(output)} = openminds.internal.mixedtype.recordingactivity.Output()

        % Add all agents that performed this activity.
        performedBy (1,:) openminds.internal.mixedtype.recordingactivity.PerformedBy ...
            {mustBeMinLength(performedBy, 1), mustBeListOfUniqueItems(performedBy)} = openminds.internal.mixedtype.recordingactivity.PerformedBy()
        ...
        studyTarget (1,:) openminds.internal.mixedtype.recordingactivity.StudyTarget ...
            {mustBeMinLength(studyTarget, 1), mustBeListOfUniqueItems(studyTarget)} = openminds.internal.mixedtype.recordingactivity.StudyTarget()
    end
