...
%                            Enter the official abbreviation of this anatomical atlas.
%
...
%   This class was auto-generated by the openMINDS pipeline
    ...
    properties (SetObservable)
        ...
        digitalIdentifier (1,:) openminds.internal.mixedtype.anatomicalatlas.DigitalIdentifier ...
            {mustBeScalarOrEmpty(digitalIdentifier)} = openminds.internal.mixedtype.anatomicalatlas.DigitalIdentifier()

        % Add the publication or file that acts as the documentation of this research product. Inherited by all product versions unless overridden at the version level.
        documentation (1,:) openminds.internal.mixedtype.anatomicalatlas.Documentation ...
            {mustBeScalarOrEmpty(documentation)} = openminds.internal.mixedtype.anatomicalatlas.Documentation()
        ...
        keyword (1,:) openminds.internal.mixedtype.anatomicalatlas.Keyword ...
            {mustBeMinLength(keyword, 1), mustBeListOfUniqueItems(keyword)} = openminds.internal.mixedtype.anatomicalatlas.Keyword()
        ...
        relatedPublication (1,:) openminds.internal.mixedtype.anatomicalatlas.RelatedPublication ...
            {mustBeMinLength(relatedPublication, 1), mustBeListOfUniqueItems(relatedPublication)} = openminds.internal.mixedtype.anatomicalatlas.RelatedPublication()
        ...
        usedTaxon (1,:) openminds.internal.mixedtype.anatomicalatlas.UsedTaxon ...
            {mustBeScalarOrEmpty(usedTaxon)} = openminds.internal.mixedtype.anatomicalatlas.UsedTaxon()
    end

    properties (Access = protected)
        Required = ["contribution", "description", "fullName", "hasTerminology", "howToCite", "shortName", "usedTaxon"]
    end

    properties (Constant, Hidden)
        X_TYPE = "https://openminds.om-i.org/types/AnatomicalAtlas"
    end
    ...
    methods
        function obj = AnatomicalAtlas(structInstance, propValues)
            arguments
                structInstance (1,:) {mustBeA(structInstance, 'struct')} = struct.empty
                propValues.?openminds.sands.atlas.AnatomicalAtlas
