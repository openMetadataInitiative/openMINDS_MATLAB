...
%                            Enter the official abbreviation of this anatomical atlas version.
%
...
%
%   coordinateFramework    : (1,1) <a href="matlab:help openminds.sands.atlas.CommonCoordinateFrameworkVersion" style="font-weight:bold">CommonCoordinateFrameworkVersion</a>
%                            Add the specific common coordinate framework in which this anatomical atlas version exists.
%
...
%
%   hasTerminology         : (1,1) <a href="matlab:help openminds.sands.atlas.ParcellationTerminologyVersion" style="font-weight:bold">ParcellationTerminologyVersion</a>
%                            Enter the specific parcellation terminology of this anatomical atlas version.
%
%   homepage               : (1,1) string
...
%                            Enter the internationalized resource identifier (IRI) to the related ontological term matching this anatomical atlas version.
%
...
%
%   type                   : (1,1) <a href="matlab:help openminds.controlledterms.AtlasType" style="font-weight:bold">AtlasType</a>
%                            Add the type of this anatomical atlas version.
%
...
%                            Add the specimen(s) that were used in the creation of this anatomical atlas version.
%
...
%   This class was auto-generated by the openMINDS pipeline
    ...
    properties (SetObservable)
        ...
        % Add the specific common coordinate framework in which this anatomical atlas version exists.
        coordinateFramework (1,:) openminds.sands.atlas.CommonCoordinateFrameworkVersion ...
        ...
        % Add the globally unique and persistent digital identifier of this research product version.
        digitalIdentifier (1,:) openminds.internal.mixedtype.anatomicalatlasversion.DigitalIdentifier ...
            {mustBeScalarOrEmpty(digitalIdentifier)} = openminds.internal.mixedtype.anatomicalatlasversion.DigitalIdentifier()

        % Add the publication or file that acts as the documentation of this research product version. This value overrides the inherited value from the version-independent product.
        documentation (1,:) openminds.internal.mixedtype.anatomicalatlasversion.Documentation ...
            {mustBeScalarOrEmpty(documentation)} = openminds.internal.mixedtype.anatomicalatlasversion.Documentation()
        ...
        % Add the version-independent information about this anatomical atlas.
        isVersionOf (1,:) openminds.sands.atlas.AnatomicalAtlas ...
            {mustBeScalarOrEmpty(isVersionOf)}

        % Add all relevant keywords to this research product version either by adding controlled terms or by suggesting new terms. This value overrides the inherited value from the version-independent product.
        keyword (1,:) openminds.internal.mixedtype.anatomicalatlasversion.Keyword ...
            {mustBeMinLength(keyword, 1), mustBeListOfUniqueItems(keyword)} = openminds.internal.mixedtype.anatomicalatlasversion.Keyword()
        ...
        % Add all further publications besides the documentation that provide the original context for the production of this research product version (e.g., an original research article that used or produced the data of this research product version). This value overrides the inherited value from the version-independent product.
        relatedPublication (1,:) openminds.internal.mixedtype.anatomicalatlasversion.RelatedPublication ...
            {mustBeMinLength(relatedPublication, 1), mustBeListOfUniqueItems(relatedPublication)} = openminds.internal.mixedtype.anatomicalatlasversion.RelatedPublication()
        ...
        % Add all licenses and available data usage agreements applicable to this product version.
        usageCondition (1,:) openminds.internal.mixedtype.anatomicalatlasversion.UsageCondition ...
            {mustBeMinLength(usageCondition, 1), mustBeListOfUniqueItems(usageCondition)} = openminds.internal.mixedtype.anatomicalatlasversion.UsageCondition()

        % Add the specimen(s) that were used in the creation of this anatomical atlas version.
        usedSpecimen (1,:) openminds.internal.mixedtype.anatomicalatlasversion.UsedSpecimen ...
            {mustBeMinLength(usedSpecimen, 1), mustBeListOfUniqueItems(usedSpecimen)} = openminds.internal.mixedtype.anatomicalatlasversion.UsedSpecimen()
    ...
    properties (Access = protected)
        Required = ["accessibility", "contribution", "description", "documentation", "fullName", "hasTerminology", "howToCite", "isVersionOf", "releaseDate", "shortName", "type", "versionIdentifier", "versionSpecification"]
    end

    properties (Constant, Hidden)
        X_TYPE = "https://openminds.om-i.org/types/AnatomicalAtlasVersion"
    end

    properties (Constant, Hidden)
        LINKED_PROPERTIES = struct(...
            'accessibility', "openminds.core.miscellaneous.Accessibility", ...
            'coordinateFramework', "openminds.sands.atlas.CommonCoordinateFrameworkVersion", ...
            ...
            'isPrecededBy', "openminds.sands.atlas.AnatomicalAtlasVersion", ...
            'isVariantOf', "openminds.sands.atlas.AnatomicalAtlasVersion", ...
            'isVersionOf', "openminds.sands.atlas.AnatomicalAtlas", ...
    ...
    methods
        function obj = AnatomicalAtlasVersion(structInstance, propValues)
            arguments
                structInstance (1,:) {mustBeA(structInstance, 'struct')} = struct.empty
                propValues.?openminds.sands.atlas.AnatomicalAtlasVersion
