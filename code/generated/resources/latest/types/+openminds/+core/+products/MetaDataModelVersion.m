classdef MetaDataModelVersion < openminds.Node
...
%
%   isPrecededBy           : (1,1) <a href="matlab:help openminds.core.products.MetaDataModelVersion" style="font-weight:bold">MetaDataModelVersion</a>
%                            Add the (meta)data model version preceding this (meta)data model version.
%
%   isVariantOf            : (1,:) <a href="matlab:help openminds.core.products.MetaDataModelVersion" style="font-weight:bold">MetaDataModelVersion</a>
%                            Add all (meta)data model versions that can be used alternatively to this (meta)data model version.
%
%   isVersionOf            : (1,1) <a href="matlab:help openminds.core.products.MetaDataModel" style="font-weight:bold">MetaDataModel</a>
...
%   This class was auto-generated by the openMINDS pipeline
    ...
    properties (SetObservable)
        ...
        documentation (1,:) openminds.internal.mixedtype.metadatamodelversion.Documentation ...
            {mustBeScalarOrEmpty(documentation)} = openminds.internal.mixedtype.metadatamodelversion.Documentation()
        ...
        usageCondition (1,:) openminds.internal.mixedtype.metadatamodelversion.UsageCondition ...
            {mustBeMinLength(usageCondition, 1), mustBeListOfUniqueItems(usageCondition)} = openminds.internal.mixedtype.metadatamodelversion.UsageCondition()
    ...
    properties (Access = protected)
        Required = ["accessibility", "contribution", "description", "documentation", "fullName", "isVersionOf", "releaseDate", "shortName", "type", "versionIdentifier", "versionSpecification"]
    end
    ...
    properties (Constant, Hidden)
        LINKED_PROPERTIES = struct(...
            ...
            'isPrecededBy', "openminds.core.products.MetaDataModelVersion", ...
            'isVariantOf', "openminds.core.products.MetaDataModelVersion", ...
