...
%   This class was auto-generated by the openMINDS pipeline
    ...
    properties (SetObservable)
        ...
        % Add all technical and/or behavioral protocols associated with this specimen state.
        associatedProtocol (1,:) openminds.internal.mixedtype.subjectstate.AssociatedProtocol ...
            {mustBeMinLength(associatedProtocol, 1), mustBeListOfUniqueItems(associatedProtocol)} = openminds.internal.mixedtype.subjectstate.AssociatedProtocol()
        ...
        pathology (1,:) openminds.internal.mixedtype.subjectstate.Pathology ...
            {mustBeMinLength(pathology, 1), mustBeListOfUniqueItems(pathology)} = openminds.internal.mixedtype.subjectstate.Pathology()

        % If there is a temporal relation between the states of a specimen (set), enter the relative time that has passed between this and the preceding specimen (set) state referenced under 'descendedFrom'.
        relativeTimeIndication (1,:) openminds.internal.mixedtype.subjectstate.RelativeTimeIndication ...
            {mustBeScalarOrEmpty(relativeTimeIndication)} = openminds.internal.mixedtype.subjectstate.RelativeTimeIndication()
