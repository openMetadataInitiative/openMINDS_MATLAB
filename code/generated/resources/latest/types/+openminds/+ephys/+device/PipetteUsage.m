...
%   This class was auto-generated by the openMINDS pipeline
    ...
    properties (SetObservable)
        ...
        anatomicalLocation (1,:) openminds.internal.mixedtype.pipetteusage.AnatomicalLocation ...
            {mustBeScalarOrEmpty(anatomicalLocation)} = openminds.internal.mixedtype.pipetteusage.AnatomicalLocation()
        ...
        labelingCompound (1,:) openminds.internal.mixedtype.pipetteusage.LabelingCompound ...
            {mustBeScalarOrEmpty(labelingCompound)} = openminds.internal.mixedtype.pipetteusage.LabelingCompound()
        ...
        metadataLocation (1,:) openminds.internal.mixedtype.pipetteusage.MetadataLocation ...
            {mustBeMinLength(metadataLocation, 1), mustBeListOfUniqueItems(metadataLocation)} = openminds.internal.mixedtype.pipetteusage.MetadataLocation()

        % Enter the resistance of the pipette during its use.
        pipetteResistance (1,:) openminds.internal.mixedtype.pipetteusage.PipetteResistance ...
            {mustBeScalarOrEmpty(pipetteResistance)} = openminds.internal.mixedtype.pipetteusage.PipetteResistance()
        ...
        usedSpecimen (1,:) openminds.internal.mixedtype.pipetteusage.UsedSpecimen ...
            {mustBeScalarOrEmpty(usedSpecimen)} = openminds.internal.mixedtype.pipetteusage.UsedSpecimen()
    end
