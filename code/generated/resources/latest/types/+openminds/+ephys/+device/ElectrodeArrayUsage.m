...
%   This class was auto-generated by the openMINDS pipeline
    ...
    methods % Hand out the instances a mixed type set holds, not the set
        function value = get.anatomicalLocationOfArray(obj)
            value = obj.anatomicalLocationOfArray.unwrap();
        end
        function value = get.anatomicalLocationOfElectrodes(obj)
            value = obj.anatomicalLocationOfElectrodes.unwrap();
        end
        function value = get.contactResistances(obj)
            value = obj.contactResistances.unwrap();
        end
