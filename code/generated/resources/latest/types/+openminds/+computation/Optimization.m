classdef Optimization < openminds.Node
...
%
%   output              : (1,:) <a href="matlab:help openminds.core.data.File" style="font-weight:bold">File</a>, <a href="matlab:help openminds.core.data.FileBundle" style="font-weight:bold">FileBundle</a>, <a href="matlab:help openminds.core.data.LocalFile" style="font-weight:bold">LocalFile</a>, <a href="matlab:help openminds.core.products.ModelVersion" style="font-weight:bold">ModelVersion</a>
...
%   This class was auto-generated by the openMINDS pipeline
    ...
    properties (SetObservable)
        ...
        environment (1,:) openminds.internal.mixedtype.optimization.Environment ...
            {mustBeScalarOrEmpty(environment)} = openminds.internal.mixedtype.optimization.Environment()

        % Add all inputs used by this activity.
        input (1,:) openminds.internal.mixedtype.optimization.Input ...
            {mustBeMinLength(input, 1), mustBeListOfUniqueItems(input)} = openminds.internal.mixedtype.optimization.Input()
        ...
        output (1,:) openminds.internal.mixedtype.optimization.Output ...
            {mustBeMinLength(output, 1), mustBeListOfUniqueItems(output)} = openminds.internal.mixedtype.optimization.Output()

        % Add all agents that performed this activity.
        performedBy (1,:) openminds.internal.mixedtype.optimization.PerformedBy ...
            {mustBeMinLength(performedBy, 1), mustBeListOfUniqueItems(performedBy)} = openminds.internal.mixedtype.optimization.PerformedBy()
        ...
        resourceUsage (1,:) openminds.internal.mixedtype.optimization.ResourceUsage ...
            {mustBeMinLength(resourceUsage, 1), mustBeListOfUniqueItems(resourceUsage)} = openminds.internal.mixedtype.optimization.ResourceUsage()
        ...
        startedBy (1,:) openminds.internal.mixedtype.optimization.StartedBy ...
            {mustBeScalarOrEmpty(startedBy)} = openminds.internal.mixedtype.optimization.StartedBy()
        ...
        studyTarget (1,:) openminds.internal.mixedtype.optimization.StudyTarget ...
            {mustBeMinLength(studyTarget, 1), mustBeListOfUniqueItems(studyTarget)} = openminds.internal.mixedtype.optimization.StudyTarget()
        ...
        wasInformedBy (1,:) openminds.internal.mixedtype.optimization.WasInformedBy ...
            {mustBeScalarOrEmpty(wasInformedBy)} = openminds.internal.mixedtype.optimization.WasInformedBy()
    end
    ...
    properties (Constant, Hidden)
        LINKED_PROPERTIES = struct(...
            ...
            'output', ["openminds.core.data.File", "openminds.core.data.FileBundle", "openminds.core.data.LocalFile", "openminds.core.products.ModelVersion"], ...
