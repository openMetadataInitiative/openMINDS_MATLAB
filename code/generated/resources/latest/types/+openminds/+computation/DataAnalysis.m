classdef DataAnalysis < openminds.Node
...
%   This class was auto-generated by the openMINDS pipeline
    ...
    properties (SetObservable)
        ...
        environment (1,:) openminds.internal.mixedtype.dataanalysis.Environment ...
            {mustBeScalarOrEmpty(environment)} = openminds.internal.mixedtype.dataanalysis.Environment()

        % Add all inputs used by this activity.
        input (1,:) openminds.internal.mixedtype.dataanalysis.Input ...
            {mustBeMinLength(input, 1), mustBeListOfUniqueItems(input)} = openminds.internal.mixedtype.dataanalysis.Input()
        ...
        output (1,:) openminds.internal.mixedtype.dataanalysis.Output ...
            {mustBeMinLength(output, 1), mustBeListOfUniqueItems(output)} = openminds.internal.mixedtype.dataanalysis.Output()

        % Add all agents that performed this activity.
        performedBy (1,:) openminds.internal.mixedtype.dataanalysis.PerformedBy ...
            {mustBeMinLength(performedBy, 1), mustBeListOfUniqueItems(performedBy)} = openminds.internal.mixedtype.dataanalysis.PerformedBy()
        ...
        resourceUsage (1,:) openminds.internal.mixedtype.dataanalysis.ResourceUsage ...
            {mustBeMinLength(resourceUsage, 1), mustBeListOfUniqueItems(resourceUsage)} = openminds.internal.mixedtype.dataanalysis.ResourceUsage()
        ...
        startedBy (1,:) openminds.internal.mixedtype.dataanalysis.StartedBy ...
            {mustBeScalarOrEmpty(startedBy)} = openminds.internal.mixedtype.dataanalysis.StartedBy()
        ...
        studyTarget (1,:) openminds.internal.mixedtype.dataanalysis.StudyTarget ...
            {mustBeMinLength(studyTarget, 1), mustBeListOfUniqueItems(studyTarget)} = openminds.internal.mixedtype.dataanalysis.StudyTarget()
        ...
        wasInformedBy (1,:) openminds.internal.mixedtype.dataanalysis.WasInformedBy ...
            {mustBeScalarOrEmpty(wasInformedBy)} = openminds.internal.mixedtype.dataanalysis.WasInformedBy()
    end
    ...
    properties (Constant, Hidden)
        LINKED_PROPERTIES = struct(...
            ...
            'input', ["openminds.core.data.File", "openminds.core.data.FileBundle", "openminds.core.data.LocalFile", "openminds.core.products.SoftwareVersion", "openminds.sands.atlas.AnatomicalAtlasVersion", "openminds.sands.atlas.CommonCoordinateFrameworkVersion"], ...
            'launchConfiguration', "openminds.computation.LaunchConfiguration", ...
            'output', ["openminds.core.data.File", "openminds.core.data.FileArchive", "openminds.core.data.FileBundle", "openminds.core.data.LocalFile"], ...
