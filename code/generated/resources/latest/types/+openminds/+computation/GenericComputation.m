...
%   This class was auto-generated by the openMINDS pipeline
    ...
    properties (SetObservable)
        ...
        environment (1,:) openminds.internal.mixedtype.genericcomputation.Environment ...
            {mustBeScalarOrEmpty(environment)} = openminds.internal.mixedtype.genericcomputation.Environment()

        % Add all inputs used by this activity.
        input (1,:) openminds.internal.mixedtype.genericcomputation.Input ...
            {mustBeMinLength(input, 1), mustBeListOfUniqueItems(input)} = openminds.internal.mixedtype.genericcomputation.Input()
        ...
        output (1,:) openminds.internal.mixedtype.genericcomputation.Output ...
            {mustBeMinLength(output, 1), mustBeListOfUniqueItems(output)} = openminds.internal.mixedtype.genericcomputation.Output()

        % Add all agents that performed this activity.
        performedBy (1,:) openminds.internal.mixedtype.genericcomputation.PerformedBy ...
            {mustBeMinLength(performedBy, 1), mustBeListOfUniqueItems(performedBy)} = openminds.internal.mixedtype.genericcomputation.PerformedBy()
        ...
        resourceUsage (1,:) openminds.internal.mixedtype.genericcomputation.ResourceUsage ...
            {mustBeMinLength(resourceUsage, 1), mustBeListOfUniqueItems(resourceUsage)} = openminds.internal.mixedtype.genericcomputation.ResourceUsage()
        ...
        startedBy (1,:) openminds.internal.mixedtype.genericcomputation.StartedBy ...
            {mustBeScalarOrEmpty(startedBy)} = openminds.internal.mixedtype.genericcomputation.StartedBy()
        ...
        studyTarget (1,:) openminds.internal.mixedtype.genericcomputation.StudyTarget ...
            {mustBeMinLength(studyTarget, 1), mustBeListOfUniqueItems(studyTarget)} = openminds.internal.mixedtype.genericcomputation.StudyTarget()
        ...
        wasInformedBy (1,:) openminds.internal.mixedtype.genericcomputation.WasInformedBy ...
            {mustBeScalarOrEmpty(wasInformedBy)} = openminds.internal.mixedtype.genericcomputation.WasInformedBy()
    end
