...
%
%   isPrecededBy           : (1,1) <a href="matlab:help openminds.computation.WorkflowRecipeVersion" style="font-weight:bold">WorkflowRecipeVersion</a>
%                            Add the workflow recipe version preceding this workflow recipe version.
%
%   isVariantOf            : (1,:) <a href="matlab:help openminds.computation.WorkflowRecipeVersion" style="font-weight:bold">WorkflowRecipeVersion</a>
%                            Add all workflow recipe versions that can be used alternatively to this workflow recipe version.
%
%   isVersionOf            : (1,1) <a href="matlab:help openminds.computation.WorkflowRecipe" style="font-weight:bold">WorkflowRecipe</a>
...
%   This class was auto-generated by the openMINDS pipeline
    ...
    properties (SetObservable)
        ...
        documentation (1,:) openminds.internal.mixedtype.workflowrecipeversion.Documentation ...
            {mustBeScalarOrEmpty(documentation)} = openminds.internal.mixedtype.workflowrecipeversion.Documentation()
        ...
        hasPart (1,:) openminds.internal.mixedtype.workflowrecipeversion.HasPart ...
            {mustBeMinLength(hasPart, 1), mustBeListOfUniqueItems(hasPart)} = openminds.internal.mixedtype.workflowrecipeversion.HasPart()
        ...
        keyword (1,:) openminds.internal.mixedtype.workflowrecipeversion.Keyword ...
            {mustBeMinLength(keyword, 1), mustBeListOfUniqueItems(keyword)} = openminds.internal.mixedtype.workflowrecipeversion.Keyword()
        ...
        relatedPublication (1,:) openminds.internal.mixedtype.workflowrecipeversion.RelatedPublication ...
            {mustBeMinLength(relatedPublication, 1), mustBeListOfUniqueItems(relatedPublication)} = openminds.internal.mixedtype.workflowrecipeversion.RelatedPublication()
        ...
        usageCondition (1,:) openminds.internal.mixedtype.workflowrecipeversion.UsageCondition ...
            {mustBeMinLength(usageCondition, 1), mustBeListOfUniqueItems(usageCondition)} = openminds.internal.mixedtype.workflowrecipeversion.UsageCondition()
    ...
    properties (Constant, Hidden)
        LINKED_PROPERTIES = struct(...
            ...
            'isPrecededBy', "openminds.computation.WorkflowRecipeVersion", ...
            'isVariantOf', "openminds.computation.WorkflowRecipeVersion", ...
            'isVersionOf', "openminds.computation.WorkflowRecipe", ...
