classdef Visualization < openminds.Node
...
%   This class was auto-generated by the openMINDS pipeline
    ...
    properties (SetObservable)
        ...
        environment (1,:) openminds.internal.mixedtype.visualization.Environment ...
            {mustBeScalarOrEmpty(environment)} = openminds.internal.mixedtype.visualization.Environment()

        % Add all inputs used by this activity.
        input (1,:) openminds.internal.mixedtype.visualization.Input ...
            {mustBeMinLength(input, 1), mustBeListOfUniqueItems(input)} = openminds.internal.mixedtype.visualization.Input()
        ...
        output (1,:) openminds.internal.mixedtype.visualization.Output ...
            {mustBeMinLength(output, 1), mustBeListOfUniqueItems(output)} = openminds.internal.mixedtype.visualization.Output()

        % Add all agents that performed this activity.
        performedBy (1,:) openminds.internal.mixedtype.visualization.PerformedBy ...
            {mustBeMinLength(performedBy, 1), mustBeListOfUniqueItems(performedBy)} = openminds.internal.mixedtype.visualization.PerformedBy()
        ...
        resourceUsage (1,:) openminds.internal.mixedtype.visualization.ResourceUsage ...
            {mustBeMinLength(resourceUsage, 1), mustBeListOfUniqueItems(resourceUsage)} = openminds.internal.mixedtype.visualization.ResourceUsage()
        ...
        startedBy (1,:) openminds.internal.mixedtype.visualization.StartedBy ...
            {mustBeScalarOrEmpty(startedBy)} = openminds.internal.mixedtype.visualization.StartedBy()
        ...
        studyTarget (1,:) openminds.internal.mixedtype.visualization.StudyTarget ...
            {mustBeMinLength(studyTarget, 1), mustBeListOfUniqueItems(studyTarget)} = openminds.internal.mixedtype.visualization.StudyTarget()
        ...
        wasInformedBy (1,:) openminds.internal.mixedtype.visualization.WasInformedBy ...
            {mustBeScalarOrEmpty(wasInformedBy)} = openminds.internal.mixedtype.visualization.WasInformedBy()
    end
    ...
    properties (Constant, Hidden)
        LINKED_PROPERTIES = struct(...
            ...
            'input', ["openminds.core.data.File", "openminds.core.data.FileBundle", "openminds.core.data.LocalFile", "openminds.core.products.SoftwareVersion"], ...
    ...
    methods
        function obj = Visualization(structInstance, propValues)
            arguments
                structInstance (1,:) {mustBeA(structInstance, 'struct')} = struct.empty
                propValues.?openminds.computation.Visualization
