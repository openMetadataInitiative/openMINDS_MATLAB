...
%   This class was auto-generated by the openMINDS pipeline
    ...
    properties (SetObservable)
        ...
        environment (1,:) openminds.internal.mixedtype.simulation.Environment ...
            {mustBeScalarOrEmpty(environment)} = openminds.internal.mixedtype.simulation.Environment()

        % Add all inputs used by this activity.
        input (1,:) openminds.internal.mixedtype.simulation.Input ...
            {mustBeMinLength(input, 1), mustBeListOfUniqueItems(input)} = openminds.internal.mixedtype.simulation.Input()
        ...
        output (1,:) openminds.internal.mixedtype.simulation.Output ...
            {mustBeMinLength(output, 1), mustBeListOfUniqueItems(output)} = openminds.internal.mixedtype.simulation.Output()

        % Add all agents that performed this activity.
        performedBy (1,:) openminds.internal.mixedtype.simulation.PerformedBy ...
            {mustBeMinLength(performedBy, 1), mustBeListOfUniqueItems(performedBy)} = openminds.internal.mixedtype.simulation.PerformedBy()
        ...
        resourceUsage (1,:) openminds.internal.mixedtype.simulation.ResourceUsage ...
            {mustBeMinLength(resourceUsage, 1), mustBeListOfUniqueItems(resourceUsage)} = openminds.internal.mixedtype.simulation.ResourceUsage()
        ...
        startedBy (1,:) openminds.internal.mixedtype.simulation.StartedBy ...
            {mustBeScalarOrEmpty(startedBy)} = openminds.internal.mixedtype.simulation.StartedBy()
        ...
        studyTarget (1,:) openminds.internal.mixedtype.simulation.StudyTarget ...
            {mustBeMinLength(studyTarget, 1), mustBeListOfUniqueItems(studyTarget)} = openminds.internal.mixedtype.simulation.StudyTarget()
        ...
        wasInformedBy (1,:) openminds.internal.mixedtype.simulation.WasInformedBy ...
            {mustBeScalarOrEmpty(wasInformedBy)} = openminds.internal.mixedtype.simulation.WasInformedBy()
    end
    ...
    properties (Constant, Hidden)
        LINKED_PROPERTIES = struct(...
            ...
            'input', ["openminds.core.data.File", "openminds.core.data.FileBundle", "openminds.core.data.LocalFile", "openminds.core.products.ModelVersion", "openminds.core.products.SoftwareVersion"], ...
    ...
    methods
        function obj = Simulation(structInstance, propValues)
            arguments
                structInstance (1,:) {mustBeA(structInstance, 'struct')} = struct.empty
                propValues.?openminds.computation.Simulation
