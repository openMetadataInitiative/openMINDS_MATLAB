...
%
%   isAlternativeVersionOf : (1,:) <a href="matlab:help openminds.core.WebServiceVersion" style="font-weight:bold">WebServiceVersion</a>
%                            Add all web service versions that can be used alternatively to this web service version.
%
%   isNewVersionOf         : (1,1) <a href="matlab:help openminds.core.WebServiceVersion" style="font-weight:bold">WebServiceVersion</a>
