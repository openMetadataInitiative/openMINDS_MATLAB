...
%   PROPERTIES:
%
%   configuration : (1,1) <a href="matlab:help openminds.core.Configuration" style="font-weight:bold">Configuration</a>, <a href="matlab:help openminds.core.File" style="font-weight:bold">File</a>
