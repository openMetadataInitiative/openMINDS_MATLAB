...
%
%   isAlternativeVersionOf : (1,:) <a href="matlab:help openminds.computation.ValidationTestVersion" style="font-weight:bold">ValidationTestVersion</a>
%                            Add all validation test versions that can be used alternatively to this validation test version.
%
%   isNewVersionOf         : (1,1) <a href="matlab:help openminds.computation.ValidationTestVersion" style="font-weight:bold">ValidationTestVersion</a>
