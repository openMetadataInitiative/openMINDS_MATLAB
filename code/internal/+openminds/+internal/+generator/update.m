...
%       openminds.internal.update('force')
    ...
    elseif isempty(previousCommitID)
        ...
        schemaFolderPath = fullfile(openminds.internal.constants.Paths.GeneratedFolder, 'matlab', '+openminds');
    ...
    if ~any(strcmp(currentPathList, openminds.internal.constants.Paths.GeneratedFolder))
        addpath(genpath(openminds.internal.constants.Paths.GeneratedFolder))
    end
end
